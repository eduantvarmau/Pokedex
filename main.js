const fetchPokemon = ()=>{
    ...
    fetch(url).then((res)=>{
        ...
        let pokeId = "Nombre: " + data.name;
        let pokeNo = "Número: " + data.id;
        let pokeType = "Tipo: " + data.types[0].type.name;
        let pokeHeight ="Altura: " + data.height;
        let pokeWeight ="Peso: " + data.weight;
        //STATS
        //let pokeEstd = data.stats[0].stat.name + ":" + data.stats[0].base_stat;
        let pokeHp = "Vida: " + data.stats[0].base_stat;
        let pokeAttack = "Ataque: " + data.stats[1].base_stat;
        let pokeDef = "Defensa: " + data.stats[2].base_stat;
        let pokeSata = "Ataque especial: " + data.stats[3].base_stat;
        let pokeSdef = "Defensa especial: " + data.stats[4].base_stat;
        let pokeSpeed = "Velocidad: " + data.stats[5].base_stat;

        let pokeMov = "Movimiento principal: " + data.moves[0].move.name;
